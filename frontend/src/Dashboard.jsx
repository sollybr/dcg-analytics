        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li>
                Dataset provided by{' '}
                <a href="https://github.com/TakaOtaku/Digimon-Card-App" target="_blank" rel="noopener noreferrer">
                  TakaOtaku/Digimon-Card-App
                </a>
              </li>
              <li>
                Official Digimon Card Game:{' '}
                <a href="https://world.digimoncard.com/" target="_blank" rel="noopener noreferrer">
          ...
          <div className="footer-section">
            ...
            <p>
              ...
              All card artwork, names, and trademarks belong to <strong>Bandai Namco Entertainment</strong>, <strong>Toei Animation</strong>, and <strong>WiZ/Shueisha</strong>.
            </p>
          </div>
        </div>
